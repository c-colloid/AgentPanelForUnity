...
- **CLI とのやり取りを追う**: `research/02-claude-cli-protocol.md` → `02b` → `02c`(サブエージェント)。
- **UapOps(Unity 操作ツール)**: `research/09-editor-api-surface.md` と `design-notes/2026-08-01-phase5-unity-ops-design.md`。
