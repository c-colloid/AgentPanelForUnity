namespace Colloid.AgentPanel.UI
{
    ...
    public sealed class UiStrings
    {
        ...
        /// <summary>{0} = the updater's last output line. Shown only until the reconnect that follows the update.</summary>
        public readonly string SettingsCliUpdateDoneFmt = "Update finished: {0} The panel reconnects to the new version on its own (after the current reply, if one is running).";
