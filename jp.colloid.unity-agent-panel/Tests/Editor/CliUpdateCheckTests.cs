...
namespace Colloid.AgentPanel.Tests
{
    ...
    public class CliUpdateCheckTests
    {
        ...
        {
            Assert.IsNull(SettingsView.DescribeCliUpdateState(false, false, null, "2.1.218", false, null, 0, 0));
        }
        ...
        public void DescribeCliUpdateState_ARunningOrFinishedUpdateOutranksTheCheck()
        {
            ...
            string running = SettingsView.DescribeCliUpdateState(false, true, "2.1.220", "2.1.218", true, null,
                start, start + 7 * System.TimeSpan.TicksPerSecond);
            ...
            string failedText = SettingsView.DescribeCliUpdateState(false, true, "2.1.220", "2.1.218", false, failed, 0, 0);
